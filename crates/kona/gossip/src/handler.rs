...
/// Trait for processing incoming messages and determining their acceptance.
...
impl BlockHandler {
    ...
    /// Encodes a [`OpNetworkPayloadEnvelope`] into a byte array based on the specified topic.
    pub fn encode(
        &self,
        topic: IdentTopic,
