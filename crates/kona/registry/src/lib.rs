...
#![doc(
    html_logo_url = "https://raw.githubusercontent.com/base/base/main/assets/logo.png",
    html_favicon_url = "https://raw.githubusercontent.com/base/base/main/assets/favicon.ico",
...
use base_genesis::L1ChainConfig;
pub use base_genesis::{Chain, ChainConfig, ChainList, RollupConfig};
...
/// Returns a [`RollupConfig`] by its alloy chain identifier.
