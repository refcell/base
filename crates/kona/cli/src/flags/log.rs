...
pub struct LogArgs {
    ...
    #[arg(long = "logs.stdout.format", default_value = "full", env = "BASE_LOG_STDOUT_FORMAT")]
    pub stdout_format: LogFormat,
    /// The directory to store the log files.
    /// If not set, no logs are printed to files.
    #[arg(long = "logs.file.directory", env = "BASE_LOG_FILE_DIRECTORY")]
    ...
    /// compact: The logs are printed in a compact format.
    /// logfmt: The logs are printed in logfmt key=value format.
    #[arg(long = "logs.file.format", default_value = "full", env = "BASE_LOG_FILE_FORMAT")]
    ...
    #[arg(long = "logs.file.rotation", default_value = "never", env = "BASE_LOG_FILE_ROTATION")]
