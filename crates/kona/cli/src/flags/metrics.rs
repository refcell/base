//! Utility module to house implementation and declaration of `MetricsArgs` since it's being used
//! in multiple places, it's just being referenced from this module.
