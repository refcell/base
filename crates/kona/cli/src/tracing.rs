        ...
        let file_layer = self.file_logs.as_ref().map(|file_logs| {
            ...
            let appender = match file_logs.rotation {
                LogRotation::Minutely => {
                    tracing_appender::rolling::minutely(directory_path, "base.log")
                }
                LogRotation::Hourly => {
                    tracing_appender::rolling::hourly(directory_path, "base.log")
                }
                LogRotation::Daily => tracing_appender::rolling::daily(directory_path, "base.log"),
                LogRotation::Never => tracing_appender::rolling::never(directory_path, "base.log"),
            };
