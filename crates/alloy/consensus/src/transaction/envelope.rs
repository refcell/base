...
impl<T> TryFrom<EthereumTxEnvelope<T>> for OpTxEnvelope {
    ...
    fn try_from(value: EthereumTxEnvelope<T>) -> Result<Self, Self::Error> {
        Self::try_from_eth_envelope(value).map_err(|e| *e)
    }
}
