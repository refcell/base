...
| [Unified load testing](base-load-test.md) | Unified command preserves measured load, drain, recovery and output contracts; rescue works without a load config. | Focused parser tests, low-rate devnet matrices, balance assertions |
